...
# text preprocessing
vectorizer = CountVectorizer(analyzer=nltkAnalyzer())
count_bda = vectorizer.fit_transform(reviewsText)

# train test split
split_data = train_test_split(count_bda, scores, test_size=1/3, shuffle=True,
                              stratify=scores)
